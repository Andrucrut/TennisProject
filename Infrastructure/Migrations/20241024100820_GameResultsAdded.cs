...
{
    /// <inheritdoc />
    public partial class GameResultsAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameUserResult", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameUserResult_GameResults_GameResultId",
                        column: x => x.GameResultId,
                        principalTable: "GameResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameUserResult_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameUserResult_GameResultId",
                table: "GameUserResult",
                column: "GameResultId");

            migrationBuilder.CreateIndex(
                name: "IX_GameUserResult_UserId",
                table: "GameUserResult",
                column: "UserId");
        }
